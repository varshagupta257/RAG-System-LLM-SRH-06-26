...
# ==========================================
# Put your real API key string inside these quotes
genai.configure(api_key="xxxxxxxxxxxxxx")

# Using the standard production Gemini model for fast, accurate text processing
...
# ==========================================
# STEP 2: CHUNKING STRATEGY (V1.3 PARAMETERS)
# ==========================================
...
# ==========================================
# STEP 5: AUTOMATED EVALUATION LOOP (GEMINI)
# ==========================================
print("\n" + "="*60)
print(" RUNNING EVALUATION SUITE: VERSION 1.2 (GOOGLE GEMINI) ")
print("="*60 + "\n")
...
for item in EVAL_QUESTIONS:
    ...
    # Strict prompt configuration constraint instruction
    prompt = f"""
...
"""
    ...
    # Execute request using Gemini Cloud instance API
    response = gemini_model.generate_content(prompt)
    
    # Display the results clearly for manual entry into your evaluation sheet
    print(f"\n--- RAG ANSWER [V1.3 - GEMINI] FOR {item['id']} ---")
    print(response.text.strip())
    print("-" * 60 + "\n")

print("Gemini Evaluation run completed successfully.")