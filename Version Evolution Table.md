...
V2.0,Scalable RAG,ChromaDB,Persistent storage migration,Enabled long-term indexing.
...
V3.0,Advanced,MMR Fetching,Diversity-based fetch_k=20,Reduced redundant information.
...
V4.0,Deterministic,Metadata Filters,Strict fiscal-year filtering,Eliminated cross-year contamination.
