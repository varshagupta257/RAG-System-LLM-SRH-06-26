...
# Path where Chroma stores data locally
...
# ==========================================
# STEP 2: CHUNKING STRATEGY (V2.2 OPTIMIZED SPEC)
# ==========================================
...
# ==========================================
# STEP 5: AUTOMATED EVALUATION LOOP WITH MMR
# ==========================================
print("\n" + "="*60)
print(" RUNNING EVALUATION SUITE: VERSION 3.0 (MMR RETRIEVAL) ")
print("="*60 + "\n")

# Initialize the retriever configuration specifically to use MMR diversity ranking
retriever = vector_db.as_retriever(
    search_type="mmr",
    search_kwargs={"k": 10, "fetch_k": 20,"lambda_mult": 0.75}
)
